...
/**
 * TestSuite for the hext.flow.async.Cascade class.
 *
 * TODO: mock ThreadExecutor
 */
class TestCascade extends hext.flow.tests.concurrent.TestCascade
{
    /**
     * @{inherit}
     */
    ...
    {
        this.cascade = new Cascade<Int>(new hext.threading.ThreadExecutor());
    }
