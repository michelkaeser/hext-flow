...
class Future<T> implements IStringable
{
     ...
     *
     * @throws hext.flow.WorkflowException if the Future has not been resolved yet (since the non-threaded version can't wait)
     */
     ...
     *
     * @throws hext.flow.WorkflowException if the Future has already been marked as ready
     */
